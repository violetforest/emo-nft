let colors = [
    ...
    {bg: 'purpleskull.jpg', color: '#fff', bg2: 'purpleskull.jpg', repeat: 'repeat', bgSize: '30%', bgAttach: 'scroll'},
    {bg: 'pinkglitter.jpg', color: '#fff', bg2: 'black.jpg', repeat: 'repeat', bgSize: '20%', bgAttach: 'scroll'},
    {bg: 'swirlstars.jpg', color: '#fff', bg2: 'black.jpg', repeat: 'repeat', bgSize: '100%', bgAttach: 'fixed'}
]
